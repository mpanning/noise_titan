...
Usage: python generate_noise.py pklfile minMw

pklfile and minMw are optional arguments.  
...
if len(sys.argv) > 1: #Assumes argv[1] is pickle file
    ...
    setmin = True
    try:
        min_Mw = float(sys.argv[2])
    except (IndexError): # If no min_Mw argument is given
        setmin = False
        min_Mw = -999.0
